    ...
    <main className="min-h-dvh bg-zinc-50 px-8 py-12 dark:bg-zinc-950">
      <div className="mx-auto max-w-5xl">
        <div className="flex items-baseline justify-between">
          ...
          <Link href="/warehouse" className="text-sm text-zinc-500 hover:underline">
            ← Warehouse
          </Link>
        </div>
        ...
        <div className="mt-4 flex justify-end">
          <Link
            href="/warehouse/inspections/new"
                ...
                return (
                  ...
                  >
                    <td className="px-3 py-2 tabular-nums">
                      <Link href={`/warehouse/inspections/${row.id}`} className="hover:underline">
              ...
              {inspections.length === 0 && (
                <tr>
                  <td colSpan={6} className="px-3 py-10 text-center text-zinc-500">
                    No inspections yet.{" "}
                    <Link href="/warehouse/inspections/new" className="underline">
                      Record one
                    </Link>
                    .
                  </td>

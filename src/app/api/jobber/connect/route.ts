 ...
 *
 * Kicks off the Jobber OAuth flow. Sets a short-lived CSRF cookie and
 * redirects the user to Jobber's authorize URL. Jobber will redirect back
 * to /api/jobber/callback after they approve.
 *
...
export async function GET() {
  // Admin-gate the install. Anyone else gets a 403.
